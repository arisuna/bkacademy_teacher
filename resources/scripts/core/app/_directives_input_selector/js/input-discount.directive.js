...
(function () {
    ...
    angular
        ...
        .directive('discountInput', discountInput);

    discountInput.$inject = ['$translate', 'urlBase', '$timeout'];

    function discountInput($translate, urlBase, $timeout) {

        return {
            restrict: 'E',

            templateUrl: urlBase.tplApp('app', '_directives_input_selector', 'input-discount'),
            ...
            controller: ["$scope", function ($scope) {
                ...
                $scope.type = this.type = $scope.type || 1;
                $scope.placeholder = this.placeholder;
            }],

            controllerAs: "discountInput"
        };
    }
})();
