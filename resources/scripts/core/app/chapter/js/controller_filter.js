...
(function () {
    ...
    App.controller('ChapterFilter', ['$scope', '$http', '$state', '$window',
        '$translate', '$stateParams', '$filter', '$timeout', 'urlBase',
        '$rootScope', 'ngDialog', 'WaitingService', 'AppDataService', 'AppSystem', 'AppChapterService',
        function ($scope, $http, $state, $window,
            ...
            $scope.broadcastFilter = function () {
                ...
                $rootScope.$broadcast('chapter_filter_update', filters);
            }
