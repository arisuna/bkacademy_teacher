(function () {
    ...
    angular
        ...
        .directive('appAttributeTypesSelector', appAttributeTypesSelector);

        appAttributeTypesSelector.$inject = ['$translate', '$timeout', 'urlBase', 'AppAttributeService', 'Utils', 'ngDialog' , 'AppSystem'];

    function appAttributeTypesSelector($translate, $timeout, urlBase, AppAttributeService, Utils,ngDialog, AppSystem ) {
        var directive = {
            restrict: 'EA',
            replace: true,
            scope: {
            ...
            templateUrl: urlBase.tplApp('app', '_directives_input', 'attribute-types-selector-item'),
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                $scope.initFn = function () {
                    ...
                    AppAttributeService.getAttributesList().then(function (res) {
                        if (res.success) {
                ...
                $scope.openSearchDialog = function ($event) {
                    ...
                    let searchDialog = ngDialog.open({
                        template: urlBase.tplApp('app', '_directives_input', 'attribute-types-selector-search-dialog'),
