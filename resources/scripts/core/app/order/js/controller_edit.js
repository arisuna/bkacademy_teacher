...
(function () {
    ...
    App.controller('OdrerEditController', ['$scope', '$http', '$stateParams', '$state', 'WaitingService', 'AppDataService', 'AppSystem', 'AppAclService', 'AppBusinessOrderService',
        function ($scope, $http, $stateParams, $state, WaitingService, AppDataService, AppSystem, AppAclService, AppBusinessOrderService) {
            ...
            $scope.getDetailFn = function () {
                ...
                AppBusinessOrderService.detailBusinessOrder(id).then(
                    function (res) {
                        if (res.success) {
