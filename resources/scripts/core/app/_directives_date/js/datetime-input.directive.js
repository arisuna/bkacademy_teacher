...
(function () {
    ...
    datetimeInput.$inject = ['urlBase', '$document', '$timeout'];

    function datetimeInput (urlBase, $document, $timeout) {
        return {
            restrict: 'E',
            scope: {
                datetime: '=',
            ...
            replace: true,
            templateUrl: urlBase.tplApp('gms', '_directives_date', 'datetime-input'),
            compile: function () {
                return {
