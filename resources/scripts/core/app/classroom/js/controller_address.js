...
(function () {
    'use strict';
    App.controller('AddressController', ['$scope', '$http', '$stateParams', '$state', '$translate', '$timeout', 'WaitingService', 'AppDataService', 'AppSystem', 'AppClassroomService', 'AppAddressService', 'ngDialog', 'urlBase', 'currentClassroom', 'type', 'address',
        function ($scope, $http, $stateParams, $state, $timeout, $translate, WaitingService, AppDataService, AppSystem, AppClassroomService, AppAddressService, ngDialog, urlBase, currentClassroom, type, address) {
            $scope.isLoading = false;
            $scope.isEditable = false;
            $scope.tabActive = 1;
            $scope.saving = false;
            $scope.classroom = currentClassroom;
            $scope.address = {
                classroom_id: $scope.classroom.id ? $scope.classroom.id : null,
                vn_district_id: null,
                vn_ward_id: null,
                vn_province_id: null,
                name: '',
            ...
            console.log("currentClassroom", address)
