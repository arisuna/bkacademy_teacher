(function (window, undefined) {
    ...
    angular
        .module('app.utils')
        .factory('simpleExcelFactory', simpleExcelFactory);

    simpleExcelFactory.$inject = ['$window'];

    function simpleExcelFactory($window) {
        ...
        return {
            getNewXlsWriter: function () {
                return new SimpleExcel.Writer.CSV();
            },
            getNewXlsCell: function () {
                return SimpleExcel.Cell;
            },
            getNewXlsSheet: function () {
                return new SimpleExcel.Sheet();
            }
        }
