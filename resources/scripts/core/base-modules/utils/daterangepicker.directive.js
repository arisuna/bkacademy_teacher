(function () {
    ...
    dateRangePickerDirective.$inject = ['$compile', '$timeout', '$parse', 'dateRangePickerConfig', 'moment'];

    function dateRangePickerDirective($compile, $timeout, $parse, dateRangePickerConfig, moment) {
        return {
            require: 'ngModel',
            restrict: 'A',
            scope: {
            ...
            link: function ($scope, element, attrs, modelCtrl) {
                var _clear, _init, _initBoundaryField, _mergeOpts, _picker, _setDatePoint, _setEndDate,
                    _setStartDate, _validateRange, allowInvalid, customOpts, el, getViewValue, opts,
                    setModelOptions;
                _mergeOpts = function () {
