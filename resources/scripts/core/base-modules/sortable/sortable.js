(function () {
    ...
    var mainModule = angular.module('app.sortable');
...
(function () {
     ...
     */
    mainModule.controller('app.sortable.sortableController', ['$scope', function ($scope) {
    ...
    mainModule.directive('asSortable',
        function () {
            return {
                ...
                restrict: 'A',
                scope: true,
                controller: 'app.sortable.sortableController',
...
(function () {
     ...
     */
    mainModule.controller('app.sortable.sortableItemHandleController', ['$scope', function ($scope) {
    ...
    mainModule.directive('asSortableItemHandle', ['sortableConfig', '$helper', '$window', '$document', '$timeout',
        function (sortableConfig, $helper, $window, $document, $timeout) {
            return {
                ...
                scope: true,
                restrict: 'A',
                controller: 'app.sortable.sortableItemHandleController',
                link: function (scope, element, attrs, itemController) {
                    ...
                    dragStart = function (event) {
                        ...
                        containment.addClass('app.sortable-un-selectable');
                    ...
                    function rollbackDragChanges() {
                        ...
                        containment.removeClass('app.sortable-un-selectable');
                    }
...
(function () {
     ...
     */
    mainModule.controller('app.sortable.sortableItemController', ['$scope', function ($scope) {
    ...
    mainModule.directive('asSortableItem', ['sortableConfig',
        function (sortableConfig) {
            return {
                ...
                restrict: 'A',
                controller: 'app.sortable.sortableItemController',
