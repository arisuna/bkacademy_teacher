...
(function () {
    ...
    angular
        ...
        .directive('appBusinessZoneFilter', appBusinessZoneFilter);

    appBusinessZoneFilter.$inject = ['$window', '$timeout', 'ngDialog', 'urlBase', '$translate', '$rootScope', 'AppBusinessZoneService', 'WaitingService'];

    function appBusinessZoneFilter($window, $timeout, ngDialog, urlBase, $translate, $rootScope, AppBusinessZoneService, WaitingService) {
        var directive = {
            restrict: 'E',
            replace: true,
            scope: {
            ...
            templateUrl: urlBase.tplBase('base-modules/app-directives-filter', 'app-business-zone-filter'),
            ...
            controller: function ($scope, $element, $attrs) {
                ...
                $scope.openSearchDialog = function ($event) {
                    ...
                    let searchDialog = ngDialog.open({
                        template: urlBase.tplBase('base-modules/app-directives-filter', 'app-business-zone-filter-dialog'),
                        ...
                        controller: ['$scope', '$element', '$rootScope', 'AppBusinessZoneService','object_selected', function ($scope, $element, $rootScope, AppBusinessZoneService, object_selected) {
                            ...
                            $scope.searchItems = function () {
                                ...
                                AppBusinessZoneService.search($scope.searchConfig).then(function (res) {
                                    if (res.success == true) {
