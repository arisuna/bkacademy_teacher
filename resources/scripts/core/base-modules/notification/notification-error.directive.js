(function () {
    ...
    angular
        ...
        .directive('notificationError', notificationError);

    notificationError.$inject = ['$translate', 'urlBase', '$state'];

    function notificationError($translate, urlBase, $state) {

        var directive = {
            restrict: 'EA',
            replace: true,
            templateUrl: urlBase.tplBase('base-modules/notification', 'error'),
