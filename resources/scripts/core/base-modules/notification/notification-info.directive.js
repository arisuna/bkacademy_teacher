(function () {
    ...
    angular
        ...
        .directive('notificationInfo', notificationInfo);

    notificationInfo.$inject = ['$translate', 'urlBase', '$state'];

    function notificationInfo($translate, urlBase, $state) {

        var directive = {
            restrict: 'EA',
            replace: true,
            templateUrl: urlBase.tplBase('base-modules/notification', 'info'),
