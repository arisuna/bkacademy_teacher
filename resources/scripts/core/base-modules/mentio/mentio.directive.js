            ...
            return {
                ...
                link: function (scope, element) {
                    ...
                    scope.adjustScroll = function (direction) {
                        ...
                        console.log('menuItemsList.scrollTop ', menuItemsList.scrollTop );
                        console.log('menuItem.offsetHeight', menuItem.offsetHeight );
                    };
    ...
    .factory('mentioUtil', ["$window", "$location", "$anchorScroll", "$timeout", function ($window, $location, $anchorScroll, $timeout) {
        ...
        function popUnderMention (ctx, triggerCharSet, selectionEl, requireLeadingSpace) {
            ...
            if (mentionInfo !== undefined) {
                ...
                if ($window.innerHeight - coordinates.top < 400) {
                    top = 'unset';
                    left = coordinates.left + 'px';
                    right = 'unset';
                    bottom = ($window.innerHeight - coordinates.top + 20) + 'px';
                }

                if ($window.innerWidth - coordinates.left < 400) {
                    left = 'unset';
                    right = ($window.innerWidth - coordinates.left) + 'px';
                }
