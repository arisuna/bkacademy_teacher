...
(function () {
    ...
    function sidebar($rootScope, $timeout, $window, Utils) {
        ...
        function link(scope, element, attrs) {
            ...
            var eventName = typeof Utils.isTouch == 'function' && Utils.isTouch() ? 'click' : 'mouseenter';
            var subNav = $();

            $sidebar.on(eventName, '.nav > li', function () {

                if ((typeof Utils.isSidebarCollapsed == 'function' && Utils.isSidebarCollapsed()) || $rootScope.app.layout.asideHover) {
