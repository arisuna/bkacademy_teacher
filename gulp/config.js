...
const config = {
    ...
    apiHostNames: {
        preprod: 'https://api-preprod.sanmayxaydung.com',
        prod: 'https://api.sanmayxaydung.com',
        ...
        prod_eu: 'https://api-geo.sanmayxaydung.com',
        thinhdev_eu: 'https://eu-api.sanmayxaydung.com',
        thinhdev_local: 'http://api.smxd.local',
        local: 'http://api.smxd.local',
        minhdev: 'https://minhdev-api.smxd.com',
    },
    staticHostNames: {
        preprod: 'https://static-preprod.sanmayxaydung.com',
        prod: 'https://static-files.sanmayxaydung.com',
        thinhdev: 'https://static-preprod.sanmayxaydung.com',
        minhdev: 'https://static-preprod.sanmayxaydung.com',
        thinhdev_eu: 'https://static-preprod.sanmayxaydung.com',
        trungdev: 'https://static-preprod.sanmayxaydung.com',
        local: 'https://static-preprod.sanmayxaydung.com',
        thinhdev_local: 'https://static-preprod.sanmayxaydung.com',
        dev: 'https://static-preprod.sanmayxaydung.com',
        prod_eu: 'https://static.sanmayxaydung.com',
        thuydev: 'https://static-preprod.sanmayxaydung.com',
        minhdev: 'https://static-preprod.sanmayxaydung.com',
    },
    hubCrossDomain: {
        preprod: 'https://hub-frontend-preprod.sanmayxaydung.com',
    ...
    assigneeAppUrl: {
        ...
        prod: 'https://assignee.sanmayxaydung.com',
